 ...
 */
 ...
 .controller('MainCtrl', function ($scope, UserService, WebApiService, $controller, $timeout, $location,$sce, settings, allInfo, $interval) {
...
$scope.saveEmails = function(){
 ...
 {
   alert('Não podem existir Emails repetidos.');
}
else
{ 
...
$scope.logout = function()
{
   ...
   $timeout(function() {
      $interval.cancel(scopeGraphicsCtrl.refreshGraphicValues);
   });
};
